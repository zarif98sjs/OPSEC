...
class Model:
    ...
    def run_MStream(self, documentSet, outputPath, wordList, AllBatchNum):
        ...
        self.outputTotalResult(outputPath, documentSet, runtime)
    ...
    def outputTotalResult(self, outputDir, documentSet, runtime):
        
        outputPath = outputDir + self.dataset + ".txt"
        print(outputPath)
        writer = open(outputPath, 'w')
        writer.write(str(0) + " " + str(runtime) + "\n")
